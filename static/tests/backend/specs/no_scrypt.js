...
describe(__filename, function () {
  it('ep_hash_auth.js no longer references the unmaintained scrypt module (#10)',
      async function () {
  ...
  it('README no longer documents the scrypt hash-generation recipe (#10)', async function () {
